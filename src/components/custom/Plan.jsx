    ...
    <div className='max-w-[1400px] m-auto p-20 grid lg:grid-cols-2 gap-4'>
      ...
      <div className='flex flex-col h-full justify-center'>
        ...
        <p className='text-2xl py-6'>
          Plan your next trip with TripGo
        </p>
        <p className='pb-6'>
        Plan your perfect trip effortlessly! Create personalized itineraries, 
        discover top destinations, book accommodations, and find exciting activities—all 
        in one place. Travel smart, stress-free, and make every journey unforgettable!
        </p>
